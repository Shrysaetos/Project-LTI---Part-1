    	...
    	<table class="table">
        	...
        	<tbody>
                <tr v-for='f in tablesInfo["flow-node-inventory:table"][0]["flow"]'>
                    ...
                    <td>ON DEVICE</td>
                    <td>
                        <button class="btn btn-info" v-on:click.prevent="editFlow">Edit</button>
    ...
    module.exports = {
        ...
        methods: {
            getSwitchesInfo: function () {
                ...
                axios.get('api/flowsSummary')
                    .then(function (response){
                        ...
                        vm.switchInfo = vm.switchesInfo.nodes.node[2];
                    })
            ...
            deleteFlow: function(flow) {
                axios.delete('api/flowsSummary/1/' + flow.id)
                    .then(response => {
                        this.getTablesS1();
                    })
            },
